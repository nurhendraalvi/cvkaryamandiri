                    ...
                    foreach($vendor as $row):
                        ?>
                            <tr>
                                ...
                                <td>
                                  <a href="<?= base_url('vendor/editvendor/'.$row->id_vendor) ?>" class="btn btn-success">Ubah</a>
                                  <a onclick="deleteConfirm('<?php echo base_url('vendor/deletevendor/'.$row->id_vendor) ?>')" href="#" class="btn btn-danger" role="button" aria-pressed="true">Hapus</a>
                                </td>
                            </tr>
                        <?php
                    endforeach;    
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/5.0.0-alpha1/js/bootstrap.min.js" integrity="sha384-oesi62hOLfzrys4LxRF63OJCXdXDipiYWBnvTl9Y9/TRlw5xlKIEHpNyvvDShgf/" crossorigin="anonymous"></script>
      ...
      <script>
          function deleteConfirm(url){
              url2 = "<?= base_url('vendor/listvendor') ?>"; //diisi dengan halaman ini
