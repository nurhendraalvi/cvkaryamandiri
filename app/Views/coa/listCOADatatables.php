<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="row">
        <div class="col">
            <div class="card">
              <div class="card-body">
              <a href="<?= base_url('coa/inputcoa') ?>" class="btn btn-warning" id="tmbh">Tambah Data COA</a>
              </div>
            </div>
        </div>
      </div> 
                    ...
                    foreach($coa as $row):
                        ?>
                            <tr>
                                ...
                                <td><?= $row->nama_coa;?></td>
                                <td>
                                  <a href="<?= base_url('coa/editcoa/'.$row->id) ?>" class="btn btn-success">Ubah</a>
                                  <a onclick="deleteConfirm('<?php echo base_url('coa/deletecoa/'.$row->id) ?>')" href="#" class="btn btn-danger" role="button" aria-pressed="true">Hapus</a>
                                </td>
                            </tr>
                        <?php
                    endforeach;    
