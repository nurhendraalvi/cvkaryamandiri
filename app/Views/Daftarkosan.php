                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="#" class="btn btn-primary">Lihat Detail Vendor</a>
                                    <a href="<?= base_url('kosan/editkosan/'.$row['id_kos']) ?>" class="btn btn-success">Ubah</a>
                                    <a onclick="deleteConfirm('<?php echo base_url('kosan/deletekosan/'.$row['id_kos']) ?>')" href="#" class="btn btn-danger" role="button" aria-pressed="true">Hapus</a>
                                </div>
                            </div>
                        </div>
                        <p>
      ...
      ?>
            ...
            <div class="row">
              <div class="col">
                  <div class="card">
                    <div class="card-body">
                    <a href="<?= base_url('kosan') ?>" class="btn btn-warning" id="tmbh">Tambah Data Kos</a>
                    </div>
                  </div>
              </div>
            </div>
