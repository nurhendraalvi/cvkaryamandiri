      ...
      ?>
        ...
        <?= form_open('kosan') ?>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="namakosan" name="namakosan" value="<?= set_value('namakosan')?>" placeholder="Diisi dengan nama kos">
                </div>
                <div class="mb-3">
                <label for="jeniskosan" class="form-label">Jenis Kos</label>
                    <select class="form-select" aria-label="Default select example" name="jeniskosan">
                        <?php
                            $lk=""; $pr = ""; $cm = "";
                            if(set_value('jeniskosan')=='Laki-Laki'){$lk="selected";}
                            elseif(set_value('jeniskosan')=='Perempuan'){$pr="selected";}
                            else{$cm="selected";}
                        ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="datetime-local" class="form-control" id="waktu" name="waktu" value="<?= set_value('waktu')?>">
                </div>
                <div class="mb-3">
