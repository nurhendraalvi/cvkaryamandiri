                    ...
                    foreach($form_input as $row):
                        ?>
                            <tr>
                                ...
                                <td><?= $row->waktu;?></td>
                                <td>
                                  <a href="<?php echo base_url('dokumen/upload/'.$row->dokumen) ?>" target="_blank">
                                  <?= $row->dokumen;?>
                                </td>
                                <td>
                                ...
                                <td><?= $row->list_hobi;?></td>
                                <td>
                                  <a class="btn btn-success btn-sm" href="<?= base_url('helloworld/editForm/'.$row->id) ?>" role="button">
                                    <i class="icon-edit"></i> Ubah
                                  </a>
                                  <a onclick="deleteConfirm('<?php echo base_url('helloworld/deleteforminput/'.$row->id) ?>')" class="btn btn-danger btn-sm" href="#" role="button">
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/5.0.0-alpha1/js/bootstrap.min.js" integrity="sha384-oesi62hOLfzrys4LxRF63OJCXdXDipiYWBnvTl9Y9/TRlw5xlKIEHpNyvvDShgf/" crossorigin="anonymous"></script>
      ...
      <script>
          function deleteConfirm(url){
              url2 = "<?= base_url('helloworld/hasilinputform') ?>"; //diisi dengan halaman ini
